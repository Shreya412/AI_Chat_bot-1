"""
Django settings for AIC project.
...
SECRET_KEY = 'django-insecure-yzl-7%j@-npa!c+vugr@5v#36$qfw75#-&m+wg)$&w2mlz2int'
...
MIDDLEWARE = [
    ...
    # It is temparary disable because of solving error we will update it
    # after find the actual soln
